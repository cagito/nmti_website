...
## 3. 제작 이미지 설명
변위 그래프 예시를 기술 매뉴얼에 들어갈 수 있는 정밀한 엔지니어링 삽도로 제작한다.
...
**Prefix:** docs/36 §2.1 · **nodeId:** `sensors/displacement-transducer` · **실패:** docs/36 §5

Example displacement time-history graph for geotechnical monitoring. X-axis time (days), Y-axis displacement (mm). Measured curve, predicted dashed line, management limit horizontal lines. Simple engineering chart on white background — NOT building deflection unless labeled δ. No decorative 3D.

## Phase AD v3 (ZIP-AUD-43 · DISP-GRAPH-01) — MAJOR_FIX

> [docs/97 §3](../../docs/97-Phase-AD-복붙-프롬프트-정본.md) · [redline v2](../redlines/IMG-049_redline_v2_외부PNG.md)
