...
> **정본:** [docs/87 §5](../../docs/87-Phase-AA-MAJOR_FIX-복붙-프롬프트-정본.md) · [redline v2](../redlines/IMG-037_redline_v2_외부PNG.md) · **판정:** MAJOR_FIX ZIP-AUD-18


## 1. 이미지 목적
균열 양측 앵커와 변위 측정 방향 표시
...
## 3. 제작 이미지 설명
균열계 설치 개념도를 기술 매뉴얼에 들어갈 수 있는 정밀한 엔지니어링 삽도로 제작한다.
...
**복붙:** [docs/87 §5](../../docs/87-Phase-AA-MAJOR_FIX-복붙-프롬프트-정본.md)

```text
Crack meter installation — measures crack width change primarily.

Note: shear, step, rotation require separate monitoring — NOT by crack meter alone.

Anchors and base plates realistic. ≠ displacement meter ≠ joint meter (039). Field logger enclosure auxiliary.

White CAD, Korean 균열계, 1920x1080.
```
