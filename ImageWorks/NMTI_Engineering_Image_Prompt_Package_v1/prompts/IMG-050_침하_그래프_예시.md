...
## 3. 제작 이미지 설명
침하 그래프 예시를 기술 매뉴얼에 들어갈 수 있는 정밀한 엔지니어링 삽도로 제작한다.
...
**Prefix:** docs/36 §2.1 · **nodeId:** `fields/soft-ground/settlement` · **실패:** docs/36 §5

Soil settlement time-history graph example. X-axis time (days), Y-axis settlement magnitude (mm, downward positive or negative per convention). Measured consolidation curve, predicted line, management criteria. For embankment/soft ground — NOT RC beam deflection (DEF-01). White chart background.

## Phase AD v3 (ZIP-AUD-44 · GRAPH-PRED-01) — **REGENERATE**

> **정본:** [docs/96](../../docs/96-외부-ZIP-신규-심각오류-10종-Phase-AD-수정계획.md) · [docs/97 §4](../../docs/97-Phase-AD-복붙-프롬프트-정본.md) · [redline v2](../redlines/IMG-050_redline_v2_외부PNG.md)

- 제목: **「침하-시간 계측 및 예측 개념도」**
- 측정 vs 예측 **시각 분리** — 예측 = **해석법 적용**(쌍곡선·Asaoka 등), **선형 외삽 금지**
- 성토·방치·추가성토·프리로딩 해제 **마커** · 잔류침하·최종침하·압밀도
- 기준점 = **영향권 밖 BM** — 침하판·연장봉 ≠ 기준점
- 관리기준 = **현장별·예시**
