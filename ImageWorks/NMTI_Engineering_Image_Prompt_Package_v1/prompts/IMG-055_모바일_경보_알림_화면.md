...
**node:** `instruments/modes/alarm-status`
**목적:** 모바일 경보 — 상태·지속·추세·조치 로그 (Phase AD)

## 최종 생성 프롬프트

```text
NMTI 홈페이지 기술자료용 2D 기술 개념도. 주제는 "모바일 경보 알림 화면"이다.
그림의 목적은 "모바일 경보 — 상태·지속·추세·조치 로그 (Phase AD)"을 설명하는 것이다.
