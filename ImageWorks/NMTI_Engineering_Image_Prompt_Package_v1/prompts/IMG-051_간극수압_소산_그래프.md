...
## 3. 제작 이미지 설명
간극수압 소산 그래프를 기술 매뉴얼에 들어갈 수 있는 정밀한 엔지니어링 삽도로 제작한다.
...
## 4. 필수 포함 요소
- 짧고 명확한 한글 라벨: 간극수압계, 필터, 그라우트, 간극수압
- 화살표, 치수선, Callout 박스
- 계측 대상 구조물 또는 지반 단면
...
## 최종 생성 프롬프트 (v3 — Phase AD · PIEZO-DISS-01)

**복붙:** [docs/97 §5](../../docs/97-Phase-AD-복붙-프롬프트-정본.md) · [redline v2](../redlines/IMG-051_redline_v2_외부PNG.md)

Pore pressure dissipation chart vs time. Y-axis Δu or u clear. Initial hydrostatic vs excess pore pressure. Embankment stage markers. Depth-specific curves possible. Drainage annotation. Do NOT generalize identical rise/dissipation per stage. White chart, 1920x1080, Korean.
