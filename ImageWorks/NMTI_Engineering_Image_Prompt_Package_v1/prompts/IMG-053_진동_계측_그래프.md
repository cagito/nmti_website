...
## 3. 제작 이미지 설명
진동 계측 그래프를 기술 매뉴얼에 들어갈 수 있는 정밀한 엔지니어링 삽도로 제작한다.
...
## 최종 생성 프롬프트 (v3 — Phase AD · VIB-GRAPH-01)

**복붙:** [docs/97 §7](../../docs/97-Phase-AD-복붙-프롬프트-정본.md) · [redline v2](../redlines/IMG-053_redline_v2_외부PNG.md)

Vibration monitoring chart. Single X-axis (time OR event index). PPV max component vs composite labeled. X/Y/Z components. Event time, source, location. Dominant frequency note. mm/s units consistent. Site-specific thresholds as example. White chart, 1920x1080.
