...
## 3. 제작 이미지 설명
구조물 안전계측 전체 개념도를 기술 매뉴얼에 들어갈 수 있는 정밀한 엔지니어링 삽도로 제작한다.
...
> **노드:** `fields/structural-safety` · 레지스트리: `book/kds-kcs-citation-registry.json`

- **KDS 11 10 15:2025**「지반계측」 §4.1.6 — 구조물 안전계측 (국가건설기준센터(KCSC))
- **KCS 11 10 15:2025**「시공 중 지반계측」 §3 — 시공·유지관리 계측 (국가건설기준센터(KCSC))
...
**Prefix:** docs/36 §2.1 · **nodeId:** `fields/structural-safety` · **실패:** docs/36 §5

Existing structure safety monitoring overview (NOT new building construction). Aging concrete building or bridge with crack gauge, tilt meter, strain gauge, ATS prism targets. Distinct from fields/building IMG-100. White CAD schematic, no brain.
