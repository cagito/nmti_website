...
> [130-수정계획](./130-기술자료-이미지-전수감사-디자인원칙-수정계획.md) · [51 §0.6](./51-계측-도면-검수-공통-원칙.md) · [131 §8](./131-P0-이미지-재작성-공통-프롬프트-정본.md)
...
| **PASS-GATE** | 설치 위치 · 측정 물리량 · 방향 — **1개라도 틀리면 PASS 불가** |

**P0 9종 큐:** [130 §3](./130-기술자료-이미지-전수감사-디자인원칙-수정계획.md) — WebP 파일명 **풀네임** 유지.
