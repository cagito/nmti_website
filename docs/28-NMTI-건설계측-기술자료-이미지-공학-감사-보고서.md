...
### P0 재작성 9종 (풀네임 · 문서·레지스트리 동기)

| IMG | WebP 파일명 | 문서 판정 |
|-----|-------------|-----------|
| IMG-024 | `IMG-024_댐-안전관리-계측-체계도_필댐6항목데이터흐름.webp` | REGENERATE |
| IMG-002 | `IMG-002_흙막이-계측-설치-대표-단면도.webp` | PASS (v6 · 픽셀 검수 권장) |
| IMG-004 | `IMG-004_어스앵커-하중계-설치-개념도_앵커두부정착구.webp` | REGENERATE |
| IMG-006 | `IMG-006_굴착-단계별-계측-흐름도_1단계최종굴착계측.webp` | REGENERATE |
| IMG-011 | `IMG-011_교량-계측-전체-개념도_상부구조교각교대기초.webp` | PASS (v4) |
| IMG-016 | `IMG-016_원호활동면-계측-해석도_원호파괴지중경사계프로파일.webp` | REGENERATE |
| IMG-035 | `IMG-035_하중계-설치-개념도_버팀보앵커하중전달.webp` | REGENERATE |
| IMG-096 | `IMG-096_주변지반-계측-설치-대표-단면도_굴착영향권복합.webp` | PASS (v5) |
| IMG-098 | `IMG-098_항만-호안-조위지하수-계측-개념도_외해사석매립지하수위.webp` | REGENERATE |
