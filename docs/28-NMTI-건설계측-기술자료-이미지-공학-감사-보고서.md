...
| # | 패턴 | 대표 사례 |
|---|------|-----------|
| 1 | **분야–도면 불일치** | `#fields/bridge`에 굴착·흙막이·주변건물 맥락 |
| 2 | **어스앵커 하중계 위치 오류** | 지반·정착장 내부처럼 표현 |
| 3 | **지중경사계 ↔ 구조물경사계 혼동** | 동일 「경사계」 라벨·외형 |
| 4 | **관측정 ↔ 간극수압계 혼동** | 개방 관 vs 폐쇄 필터 센서 동형 |
| 5 | **측정 방향·기준점 생략** | 균열계·토압계·자동광파기 |
