...
| IMG-035 | PASS | reviewed | 2026-06-22 | P1 | KDS 11 10 15:2025 표 4.1-1 · KCS 11 10 15:2025 §3.2 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 4차 — 터널 계측 기준점·측점·측선 미분리. REGENERATE. docs/92 Phase AC-1e · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | v2 Pillow — 대구 3호선 10종 callout · 처짐·케이블·풍하동·받침 반영 · Phase D W10 — redline v2 PASS · docs/113 · Phase D W10 — redline v2 PASS · docs/113 · Phase D W10 — redline v2 PASS · docs/113 · Phase D W10 — redline v2 PASS · docs/113 · Phase D W10 — redline v2 PASS · docs/113 · Phase D W10 — redline v2 PASS · docs/113 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | v2.1 BRI-EJ PASS — 양측 브라켓·핑거형 이음·보호박스 (docs/52·53) |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 4차 — 설치 배치도 아닌 개념/흐름. REGENERATE. docs/109 SOFT-LAYOUT-01 · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 2차 — 침하판·기준점·압밀 단순화. MAJOR_FIX. redline v2 미검수. docs/81 AA-2b · docs/85 · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 2차 — 측방유동 판단 과도 단순. REGENERATE. redline v2 미검수. docs/81 AA-1c · docs/85 · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 4차 — 궤도틀림·노반침하·진동 혼합. REGENERATE. docs/92 Phase AC-1g · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 3차 — A/B축 현장 방향 미연결. MAJOR_FIX. redline v2 미검수. docs/90 · docs/91 · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 3차 — θ 단순 적분=누적변위. REGENERATE. redline v2 미검수. docs/90 · docs/91 · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | ai-reviewed PASS — Z-1c 연장봉 상단=기준점. 재작도: redline v2. SETTLE-01. |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 4차 — 자석링·기준관·프로브 역할 모호. REGENERATE. docs/92 Phase AC-1b · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 4차 — 변형률=즉시 응력 판정. MAJOR_FIX. docs/92 Phase AC-2 · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 2차 — 균열폭만·전단단차회전 누락. MAJOR_FIX. redline v2 미검수. docs/81 AA-2e · docs/85 · interim body expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 2차 — 브라켓 무시·구조물 경사 단정. MAJOR_FIX. redline v2 미검수. docs/81 AA-2f · docs/85 · interim hero expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 외부 ZIP 3차 — 기준망·후시점·기상보정 누락. MAJOR_FIX. redline v2 미검수. docs/90 · docs/91 · interim hero expose (existing webp) · 2026-06-27 · ai-reviewed 재작도 예정 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | v2 TUN-CROWN PASS — 천단 측점·ATS, 와이어·앵커·로거 제거 (docs/50) |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | ai-reviewed PASS v2 — Z-1d 두부 LC=전체 축력. 재작도: redline v2. docs/77. |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | ai-reviewed PASS — Z-1e 1점 SG=전체 응력. 재작도: redline v2. docs/77. |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | render-harbor-audit-fixes.py · HAR-01~04 수정 완료 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | render-building-deflection-audit-fixes.py · DEF-01~04 수정 완료 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
...
| 검수 등급 | **PASS** |
| status | reviewed |
| 기술 오류 | 건설기간 계측 hero — ai-reviewed PNG 등록 |
| 설치 위치 오류 | — |
| 방향 오류 | — |
| 용어 오류 | — |
| 수정 지시 | — |
