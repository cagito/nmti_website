...
- `IMG-030_redline_v2_외부PNG.md` — 검수 redline

## 저장 경로

```
assets/images/technology/source/IMG-030_지하수위계-설치-개념도_관측공수위센서케이블보호함.webp
```
...
Phase 서명: `npm run sign:phase-ab -- --id IMG-030` (또는 phase 일괄)
