...
- `IMG-042_redline_v2_외부PNG.md` — 검수 redline

## 저장 경로

```
assets/images/technology/source/IMG-042_자동광파기-계측-개념도_TotalStation프리즘좌표변위.webp
```
...
Phase 서명: `npm run sign:phase-ab -- --id IMG-042` (또는 phase 일괄)
