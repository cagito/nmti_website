...
- `IMG-038_redline_v2_외부PNG.md` — 검수 redline

## 저장 경로

```
assets/images/technology/source/IMG-038_구조물-경사계-설치도_벽체교각표면.webp
```
...
Phase 서명: `npm run sign:phase-aa -- --id IMG-038` (또는 phase 일괄)
