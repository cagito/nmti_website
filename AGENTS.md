...
- **IMG-011:** 교량 **전체 개념도** — **S0-B v5 REGENERATE 대기** (`requiresReaudit`) · [185](./docs/185-IMG-024-011-최우선-재작도-실행계획.md) · [116 v3](./docs/116-IMG-011-교량-계측-전체-개념도-v3-표현-표준.md) · BRI-OV-01~10 · 현행 v4 PASS는 회귀 방지 기록
...
- **IMG-024** = 댐 hero — **S0-A 최우선 v5 REGENERATE 대기** (`requiresReaudit`) · DAM-01 침하역전·침윤선·piezo·누수 · [185](./docs/185-IMG-024-011-최우선-재작도-실행계획.md) · [32](./docs/32-IMG-024-댐-계측-개념도-오류분석-및-재작업-계획.md) · [39](./docs/39-IMG-024-댐-안전관리-계측-체계도-전면-수정-계획.md) · [152](./docs/152-IMG-024-댐-피에조-침윤선-정합성-수정계획.md)
