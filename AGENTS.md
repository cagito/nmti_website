...
- **Phase 5:** [36-CI 잠금](./docs/36-Phase5-CI-잠금-체크리스트.md) · **Program Exit** ✅ · `verify:local` · `verify:production` **30/30** (2026-06-30)
...
npm run verify:predeploy              # 배포 직전 (quick + deploy)
```
...
- **IMG-111·112·113** = 터널·철도·댐 **건설중** hero (`*/construction-phase`) — **PASS** ai-reviewed (2026-06-27) · [153](./docs/153-계측문서-용어-정본-건설중-계측.md) · WATCH 17 · **vN+1 보류** [213 §4.2](./docs/213-이미지-제작-실행계획.md)
...
1. `npm run verify:predeploy` → `npm run verify:production` **30/30**
