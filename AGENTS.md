...
- **WATERMARK-01:** 큰 Figure·hero **우하단 NMTI 로고 합성** + 우클릭·드래그 억제 — **생성 단계 로고·워터마크 금지 [183](./docs/183-이미지-생성-워터마크-금지-정본.md)** · [76 계획](./docs/76-이미지-워터마크-보호-통합-계획.md) · [77 완료](./docs/77-이미지-워터마크-보호-구현-완료-보고.md)
