...
const CONTENT = {
  "intro": {
    ...
    "sections": {
      ...
      "installation": "<p>기술자료는 설치 절차를 공통 프로세스로 정리합니다. 현장별 상세 시방은 계측관리계획서와 설계도서를 우선 적용합니다.</p><ol class=\"process-list\"><li>계측관리계획서·설계도서 검토</li><li>위험 단면·대표 측점 선정</li><li>센서 설치 및 초기치 확정</li><li>자동화·원격계측 구성</li><li>관리기준·경보 체계 운영</li></ol>",
      "data": {
        "headers": [
          "구분",
          "확인 항목",
  ...
  "fields/retaining-excavation": {
    ...
    "sections": {
      ...
      "installation": [
        ...
        "인접 건물에는 균열계·구조물경사계·자동광파기를 배치하고 초기 상태를 기록합니다.",
  ...
  "fields/tunnel": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "내공변위",
          "body": "<strong>내공변위계</strong>로 전단면 프로파일·단면 변형을 확인합니다."
        },
        {
          "title": "천단침하",
        ...
        {
          "title": "지표·지중",
          "body": "<strong>지표 및 지중침하</strong>로 상부 관리대상물 영향을 검토합니다."
        },
        {
          "title": "지중변위",
  ...
  "fields/slope": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "대책 검증",
          "body": "배수·압밀·보강공 효과를 계측으로 검증하고 경보 체계를 운영합니다."
        }
      ],
  ...
  "fields/soft-ground": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "압밀 진행",
          "body": "침하·간극수압 소산으로 압밀 진행과 강도 증가를 확인합니다."
        },
        {
          "title": "침하 예측",
  ...
  "fields/railway": {
    ...
    "metaDescription": "철도·고속철도 계측 — 노반·궤도 변위, 건설기간·운영기 계측, 인접공사 연계를 정리한 기술자료입니다.",
    "sections": {
      ...
      "installation": [
        ...
        "선로 양측·절개·교량 접속부에 자동광파기 프리즘망을 구축합니다.",
  ...
  "fields/dam": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "침하·변위",
          "body": "<strong>침하계</strong>·<strong>GNSS</strong>·경사계로 누적 변형과 변위속도를 추적합니다."
        },
        {
          "title": "응력·변형률",
          "body": "<strong>변형률계</strong>·기울기계로 제체·기초의 응력·변형 응답을 확인합니다."
        },
        {
          "title": "온도·지진",
  ...
  "fields/building": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "처짐",
          "body": "장경간 구조물의 처짐을 <strong>침하계</strong>·<strong>자동광파기</strong>로 관리합니다."
        },
        {
          "title": "기둥 축소량",
        ...
        {
          "title": "주변건물",
          "body": "굴착·진동 등 인접 영향을 <strong>균열계</strong>·<strong>구조물경사계</strong>·광파기로 확인합니다."
        },
        {
          "title": "응력·변형률",
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "원리는 유사하나 건축 구조 응답에 맞게 균열계·경사·자동광파기 배치를 조정합니다. 흙막이 hero(005)와 구분합니다."
        }
      ],
      "sources": "<div class=\"tech-sources\" id=\"sources\"><h2 class=\"tech-sources__title\">근거 기준</h2><ul class=\"tech-sources__list\"><li class=\"tech-sources__item\">· <strong>KCS 11 10 15:2025</strong>「시공 중 지반계측」 §3.9 — 건축공사 계측 <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li><li class=\"tech-sources__item\">· <strong>KDS 11 10 15:2025</strong>「지반계측」 §4.1 — 구조물·건축 계측 일반 <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li></ul><p class=\"tech-sources__disclaimer\">※ 본 자료는 건설기준(KDS/KCS) 해설이며, 구체적 관리기준·허용값·시공 상세는 설계도서, 계측관리계획서, 발주처 지침을 우선 적용합니다.</p></div>"
    },
  ...
  "fields/foundation-pile": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "장기 추세",
          "body": "연약지반·교량·고층 기초의 장기 거동을 추적합니다."
        }
      ],
  ...
  "fields/environmental-impact": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "법규·계약",
          "body": "환경·소음 관련 허용 기준과 자동 경보를 연동합니다."
        }
      ],
  ...
  "fields/retaining-excavation/adjacent-building": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "균열 감시",
          "body": "<strong>균열계</strong>로 대표 균열 폭 변화를 추적합니다."
        },
        {
          "title": "경사·기울기",
          "body": "<strong>구조물경사계</strong>로 건물 회전·부등침하를 확인합니다."
        },
        {
          "title": "절대 변위",
  ...
  "fields/retaining-excavation/surrounding-ground": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "수평변위",
          "body": "배면·측방 <strong>지중경사계</strong>로 지반 이동을 추적합니다."
        },
        {
          "title": "침하",
          "body": "<strong>침하계</strong>로 지표·층별 침하를 확인합니다."
        },
        {
          "title": "수압",
  ...
  "fields/tunnel/surface-subsidence": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "지표 안전",
          "body": "도로·건물·철도 등 관리대상물의 연직 영향을 확인합니다."
        },
        {
          "title": "천단 연계",
  ...
  "fields/tunnel/convergence": {
    ...
    "title": "내공변위",
    "sections": {
      "overview": "<p><strong>내공변위</strong>는 굴착에 따른 <strong>터널 벽면</strong>의 변위를 측정하는 항목입니다(KDS 4.1.5.2①). 단면의 수평·수직 변형으로 터널 거동을 파악하며, 과도한 내공변위는 라이닝 균열·천단침하 악화를 유발할 수 있습니다.</p><p>대표 Figure는 <strong>상부 아치 측점 P1~P5</strong>에 프리즘·타깃 또는 내장 센서를 두고, <strong>측점 간 거리·좌표 변화</strong>(<strong>측선</strong>)와 <strong>기준 측정선</strong> 대비 초기·현재 형상을 비교합니다. <strong>자동광파기</strong>·테이프 익스텐소미터 등 현장 방식을 병행할 수 있습니다. <strong>하단 노반(도로·철도)</strong>은 통행·궤도 구간으로 <strong>「노반 Open · 미계측」</strong>이며, 라이닝을 따라 연속 센서 튜브만으로 전단면을 대표하는 표현은 사용하지 않습니다.</p><p><strong>내공변위계</strong> 데이터는 MUX·데이터로거를 통해 자동 수집되며, <strong>상부 아치</strong> 전단면 프로파일 그래프에서 초기 형상 대비 현재 형상 변화를 시각화합니다. 지보 설치 전·후 프로파일 비교로 지보 효과를 정량화하고, 온도 보정 후 ΔX·ΔY 추세를 <strong>최대허용변위</strong>와 비교합니다. 막장 근처 고빈도 계측은 NATM 관찰시공에 적합합니다.</p>",
      "purpose": [
        {
          "title": "측점·측선",
          "body": "P1~P5 측점 간 내공변위 측선과 기준 측정선으로 개방 체인을 추적합니다. 노반은 Open·미계측."
        },
        {
          "title": "건축한계",
        ...
        {
          "title": "통합 모니터링",
          "body": "원격계측으로 측점별 추세·관리기준·경보를 확인합니다."
        }
      ],
      "principle": "<p>내공변위는 <strong>측점 좌표 변화</strong> 또는 <strong>측점 간 거리 변화</strong>로 확인합니다. 상부 아치·어깨·측벽에 배치한 P1~P5에서 초기 형상과 현재 형상을 비교하고, 개방 경계(P3·P5 등)에서 하부 노반과 가상 폐합(Closed Loop)을 가정하지 않습니다. <strong>자동광파기</strong> 시준·거리 측정, 테이프 익스텐소미터, 내장 변위 센서 등 설계·현장 조건에 맞는 방식을 선택합니다.</p><p>신호는 데이터로거·원격계측으로 수집하며, 발파·장비 진동 구간은 정적 변위 추출·이벤트 분리로 해석합니다. 온도 보정 후 상부 아치 프로파일을 갱신하고 <strong>천단침하</strong>·<strong>지중변위</strong>와 동일 단면에서 통합합니다.</p>",
      "installation": [
        "상부 아치·어깨·측벽에 측점 P1~P5 배치 (노반·건축한계 내부 제외).",
      ...
      "faq": [
        {
          "q": "바닥·노반 변위는 왜 없나요?",
          "a": "도로·철도·인버트가 점유하는 하부는 측점 설치·계측이 불가합니다. 상부 아치 P1~P5 개방 체인만 측정하며, 프로파일 하부는 「노반 Open · 미계측」입니다."
        },
        {
          "q": "내공변위와 천단침하 차이는?",
    ...
    "heroCaption": "터널 전단면 내공변위 — 상부 아치 P1~P5 측점·측선·기준 측정선, 건축한계, 노반 Open",
  ...
  "fields/tunnel/ground-displacement": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "영향권",
          "body": "지중경사계로 영향권 내 수평변위 프로파일을 확인합니다."
        },
        {
          "title": "지보 조정",
  ...
  "fields/bridge/abutment": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "배면 안정",
          "body": "배면 지중경사계로 측방·수평 변위를 확인합니다."
        },
        {
          "title": "균열",
  ...
  "fields/bridge/deflection": {
    ...
    "sections": {
      ...
      "installation": [
        "주경간 중앙·1/4 경간에 처짐계 또는 측량 프리즘을 배치합니다.",
        "온도 센서·기상 데이터와 연동합니다.",
        "초기치·온도 보정 기준을 확립합니다.",
        "자동광파기로 절대 처짐을 보완합니다.",
        "정적·동적 로거 채널을 구분합니다.",
        "기초침하·교각 경사와 교차 검토합니다."
      ],
      "constructionPhases": {
        "headers": [
          "단계",
  ...
  "fields/bridge/seismic": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "지진 응답",
          "body": "가속도·변위 피크를 기록합니다."
        },
        {
          "title": "잔류 변위",
          "body": "지진 후 잔류·추가 변형을 추적합니다."
        },
        {
          "title": "복구 판단",
  ...
  "fields/tunnel/construction-phase": {
    ...
    "title": "건설기간 계측",
    "sections": {
      "overview": "<p><strong>터널 건설기간 계측</strong>은 준공·운영기 계측과 구분하여, <strong>NAT·TBM 굴착·지보·라이닝</strong> 등 시공 전 기간에 내공변위·천단침하·지표·지중 변위를 단계별로 측정·보고하는 체계입니다. 운행철도·도로·건물 등 관리대상물이 상부에 있을 때 <em>railway tunnel monitoring during construction</em> 관점으로 협약·경보·운행 제한을 연계합니다.</p><p>단일 항목(내공변위·천단침하 등) 계측과 달리, <strong>공정 단계·측점 네트워크·데이터 흐름</strong>을 통합 관리합니다. 준공 시 기준선·센서 이력을 운영기 모니터링으로 이관합니다.</p><p>계측 데이터는 <strong>계측책임자</strong>가 검토하는 계측관리계획서의 계측 빈도·<strong>설계예상변위</strong>·<strong>최대허용변위</strong>와 연계하여 운영합니다. 터널 현장에서는 추세·변화속도·인접 센서의 동시 변화를 우선 검토하며, 현장별 상세 시방·허용값은 설계도서와 발주처 기준을 따릅니다.</p>",
      "purpose": [
        {
          "title": "단계별 안전",
          "body": "막장·지보·라이닝 단계별 관리기준과 누적·속도를 추적합니다."
        },
        {
          "title": "운행선 보호",
        ...
        {
          "title": "데이터 연속성",
          "body": "건설기간 초기치·이벤트 기록을 준공 인수 기준으로 확정합니다."
        },
        {
          "title": "협약·보고",
          "body": "철도·도로 관리주체와 건설기간 보고 주기·경보를 명문화합니다."
        }
      ],
      "principle": "<p>터널 건설기간 계측은 <strong>천단·내공·지표·지중</strong>을 동일 시간축·대표 단면에서 비교합니다. 천단침하와 내공변위는 <strong>별도 측선·측점</strong>으로 분리하고, 운행철도 상부는 <strong>자동광파기·침하계</strong>로 고빈도 보조합니다. 발파 구간은 <strong>진동계</strong> 이벤트와 연동합니다.</p>",
      "installation": [
        "계측관리계획서에 건설기간 항목·단계·빈도·관리기준을 명시합니다.",
      ...
      "criteria": "<p>건설기간 관리기준은 설계·KDS·인접 구조물·철도 협약에 따릅니다. 운영기(준공 후) 안전관리 기준과 혼용하지 않고, <strong>시공 단계별 허용 누적·속도</strong>를 별도 설정합니다. KCS에 따라 현장 <strong>계측책임자</strong>가 계측관리계획서·측정·보고·기준 초과 대응을 총괄합니다.</p>",
      "faq": [
        {
          "q": "건설기간과 운영기 계측 차이는?",
          "a": "건설기간은 굴착·지보·라이닝 시공 중 변위·속도 관리, 운영기는 준공 후 장기 안전·유지관리 중심입니다."
        },
        {
          "q": "운행철도 상부 터널은?",
          "a": "철도 협약·고빈도 계측·운행 제한 연계가 필수입니다. 철도 건설기간 계측 항목과 데이터를 통합합니다."
        },
        {
          "q": "내공변위·천단침하를 같이 보나요?",
        ...
        {
          "q": "준공 후 데이터는?",
          "a": "건설기간 최종값·센서 이력·보고서를 운영기 계측관리계획 인수 자료로 이관합니다."
        }
      ],
      "sources": "<div class=\"tech-sources\" id=\"sources\"><h2 class=\"tech-sources__title\">근거 기준</h2><ul class=\"tech-sources__list\"><li class=\"tech-sources__item\">· <strong>KDS 11 10 15:2025</strong>「지반계측」 §4.1.5 — 터널 계측 항목 <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li><li class=\"tech-sources__item\">· <strong>KCS 11 10 15:2025</strong>「시공 중 지반계측」 표 3.5-1 — 계측 빈도 <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li><li class=\"tech-sources__item\">· <strong>KDS 27 50 10:2023</strong>「터널 계측」 §4.1.5 — 터널 계측 (참고) <span class=\"tech-sources__grade\">[C]</span> <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li></ul><p class=\"tech-sources__disclaimer\">※ 본 자료는 건설기준(KDS/KCS) 해설이며, 구체적 관리기준·허용값·시공 상세는 설계도서, 계측관리계획서, 발주처 지침을 우선 적용합니다.</p></div>"
    },
    ...
    "heroImageId": "IMG-111",
    "heroCaption": "터널 건설기간 계측 — 굴착·지보·라이닝 단계별 내공·천단·지표 변위 통합",
    "metaDescription": "터널 건설기간 계측 — 굴착·지보·라이닝 단계별 내공·천단·지표 변위와 운행철도 구간 보호. Railway tunnel monitoring during construction.",
    "standardSources": [
      {
        "grade": "A",
        "docId": "KDS-11-10-15",
  ...
  "fields/slope/structural-displacement": {
    ...
    "title": "구조물 변위",
    "sections": {
      "overview": "<p><strong>구조물 변위</strong> 계측은 사면 하단 옹벽·석축·옹벽형 구조물의 수평·연직 변위를 <strong>변위계</strong>·<strong>자동광파기</strong>(프리즘 측점)로 측정합니다. 지표·지중 변위와 별도로 구조물 자체의 거동을 평가합니다.</p><p>부동점은 영향권 밖에 두고, 측점은 옹벽·옹벽 상부에 배치합니다. <strong>지표경사</strong>·<strong>지중경사계</strong>와 연계해 붕괴·전도 위험을 판단합니다.</p><p>계측 데이터는 <strong>계측책임자</strong>가 검토하는 계측관리계획서의 계측 빈도·<strong>설계예상변위</strong>·<strong>최대허용변위</strong>와 연계하여 운영합니다. 사면 현장에서는 추세·변화속도·인접 센서의 동시 변화를 우선 검토하며, 현장별 상세 시방·허용값은 설계도서와 발주처 기준을 따릅니다.</p>",
      "purpose": [
        {
          "title": "구조물 변위",
          "body": "옹벽·옹벽형 구조 수평·연직 변위를 추적합니다."
        },
        {
          "title": "안정 평가",
        ...
        {
          "title": "보강 검증",
          "body": "앵커·보강 공법 효과를 확인합니다."
        }
      ],
      "principle": "<p>프리즘 반사측점과 부동점 자동광파기로 3차원 변위를 산출합니다. 필요 시 옹벽에 직접 변위계를 설치해 연속 기록합니다.</p>",
      "installation": [
        "영향권 밖에 부동점·기준점을 설치합니다.",
        "옹벽 상·중·하부에 프리즘 또는 변위계를 배치합니다.",
        "시야 확보·조명·보호 조치를 합니다.",
        "지중경사계·지표경사와 동일 단면 좌표를 맞춥니다.",
        "초기 다회 측정으로 기준선을 확립합니다.",
      ...
      "faq": [
        {
          "q": "자동광파기와 변위계 중 무엇을 쓰나요?",
          "a": "원거리 다측점은 ATS+프리즘, 연속 기록·국부는 변위계가 유리합니다. 계획서에 맞게 조합합니다."
        },
        {
          "q": "부동점 위치 기준은?",
  ...
  "fields/slope/slip-surface": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "진행 판단",
          "body": "활동면 깊이 변화·속도를 추적합니다."
        },
        {
          "title": "설계 검증",
          "body": "보강 후 활동면 이동 여부를 확인합니다."
        }
      ],
  ...
  "fields/structural-safety/vibration": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "이벤트",
          "body": "발파·지진 응답을 기록합니다."
        },
        {
          "title": "손상",
          "body": "장기 특성 변화를 추적합니다."
        }
      ],
  ...
  "fields/railway/track-displacement": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "선형 유지",
          "body": "평면·종단 변위를 추적합니다."
        },
        {
          "title": "통과·轨距",
          "body": "궤도 기하학적 변화를 확인합니다."
        },
        {
          "title": "공사 연계",
  ...
  "fields/railway/construction-phase": {
    ...
    "title": "건설기간 계측",
    "sections": {
      "overview": "<p><strong>철도 건설기간 계측</strong>은 신규·개량·복선 등 <strong>시공 중</strong> 노반·道床·궤도 기준선을 확보하고, 단계별 침하·변위를 관리하는 체계입니다. 운영기 <strong>노반침하·궤도변위</strong>와 구분하며, 고속철도(KTX·SRT 등)는 더 촘촘한 주기·기준을 적용합니다(<em>high-speed railway monitoring during construction</em>).</p><p>인접 터널·굴착·발파 영향은 <strong>인접공사 영향</strong> 항목·터널 건설기간 계측과 시간 동기화합니다. 개통 전 종합 판정 후 운영기 모니터링으로 이관합니다.</p><p>계측 데이터는 <strong>계측책임자</strong>가 검토하는 계측관리계획서의 계측 빈도·<strong>설계예상변위</strong>·<strong>최대허용변위</strong>와 연계하여 운영합니다. 철도 현장에서는 추세·변화속도·인접 센서의 동시 변화를 우선 검토하며, 현장별 상세 시방·허용값은 설계도서와 발주처 기준을 따릅니다.</p>",
      "purpose": [
        {
          "title": "道床·노반 시공",
          "body": "되메우기·다짐·층별 침하를 추적합니다."
        },
        {
          "title": "궤도 기준",
        ...
        {
          "title": "인접공사 연계",
          "body": "터널·굴착·발파와 통합 데이터로 원인을 추적합니다."
        }
      ],
      "principle": "<p>철도 건설기간 계측은 <strong>노반·궤도·하부 지반</strong>을 분리 해석합니다. 궤도틀림·노반침하·진동 그래프를 한 축에 혼합하지 않고, <strong>자동광파기·침하계·GNSS</strong>를 공정 단계에 맞게 배치합니다.</p>",
      "installation": [
        "계측관리계획서에 건설기간 항목·공정별 빈도·관리기준을 명시합니다.",
      ...
      "criteria": "<p>건설기간 관리기준은 철도공사·발주처·인접공사 협약에 따릅니다. 운영기 노반·궤도 기준과 별도로 <strong>시공 단계 허용치</strong>를 설정합니다. 고속철도는 일반선보다 엄격한 속도·누적 기준을 적용합니다. KCS에 따라 현장 <strong>계측책임자</strong>가 계측관리계획서·측정·보고·기준 초과 대응을 총괄합니다.</p>",
      "faq": [
        {
          "q": "건설기간과 노반침하(운영기) 차이는?",
          "a": "건설기간은 道床·토공·궤도 시공 중 층별·단계별 관리, 운영기는 개통 후 장기 침하·인접공사 영향 중심입니다."
        },
        {
          "q": "고속철도만 다른가요?",
        ...
        {
          "q": "터널 공사와 연계는?",
          "a": "인접 터널·굴착 시 철도·터널 건설기간 데이터를 동일 시간축으로 통합합니다."
        },
        {
          "q": "개통 전 무엇을 확정하나요?",
    ...
    "heroImageId": "IMG-112",
    "heroCaption": "철도·고속철도 건설기간 계측 — 노반·궤도 시공 단계별 침하·변위",
    "metaDescription": "철도·고속철도 건설기간 계측 — 노반·궤도 시공 단계별 침하·변위와 인접공사 연계. High-speed railway monitoring during construction.",
    "standardSources": [
      {
        "grade": "A",
        "docId": "KDS-11-10-15",
  ...
  "fields/harbor/caisson": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "배면 토압",
          "body": "매립 측 토압계로 압력 변동을 추적합니다."
        },
        {
          "title": "측방 변위",
          "body": "해측 방향 변위 벡터를 확인합니다."
        }
      ],
  ...
  "fields/harbor/tide-groundwater": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "조위",
          "body": "조석에 따른 수위 변화를 기록합니다."
        },
        {
          "title": "지하수위",
          "body": "지하수위계로 심도별 수위를 추적합니다."
        },
        {
          "title": "간극수압",
          "body": "배면·기초 간극수압 분포를 확인합니다."
        }
      ],
  ...
  "fields/dam/seismic": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "잔류 효과",
          "body": "지진 후 잔류 변위·수압·누수 변화를 추적합니다."
        },
        {
          "title": "응급 판단",
  ...
  "fields/building/adjacent-building": {
    ...
    "title": "주변건물",
    "sections": {
      "overview": "<p><strong>주변건물 계측</strong>은 굴착·진동·성토 등 건축공사가 인접 건축물에 미치는 영향을 <strong>균열계</strong>, <strong>구조물경사계</strong>, <strong>자동광파기</strong>로 관리하는 항목입니다(KCS 3.9.1.1④). 손상 발생 또는 우려 시 사전·공사 중 계측을 실시합니다.</p><p>가시설·터널 인접 건물 계측과 원리는 유사하나 건축공사 맥락에서 운영합니다.</p><p>건축공사 인접 영향 계측은 사전·공사 중·종료 후 3단계로 계획합니다. 굴착·발파·진동 일지와 시간 동기화하고, 민감 건물은 계측 빈도를 높입니다.</p><p>계측 데이터는 <strong>계측책임자</strong>가 검토하는 계측관리계획서의 계측 빈도·<strong>설계예상변위</strong>·<strong>최대허용변위</strong>와 연계하여 운영합니다. 건축·인접 구조물 현장에서는 추세·변화속도·인접 센서의 동시 변화를 우선 검토하며, 현장별 상세 시방·허용값은 설계도서와 발주처 기준을 따릅니다.</p>",
      "purpose": [
        {
          "title": "손상 예방",
  ...
  "fields/dam/construction-phase": {
    ...
    "title": "건설기간 계측",
    "sections": {
      "overview": "<p><strong>댐·제방 건설기간 계측</strong>은 준공 후 안전관리(누수·간극수압·운영기 침하)와 구분하여, <strong>기초굴착·연속 콘크리트·성토·제방 축조</strong> 단계의 침하·변위·수압·온도·응력을 측정하는 체계입니다. 다측점 데이터는 <strong>원격계측시스템</strong>·<strong>데이터 관리</strong> SW로 QC·경보·일·주 보고를 자동화합니다(<em>dam construction monitoring software</em>).</p><p>건설기간 중 수화열·기초 변위와 운영기 간극수압·누수 패턴을 혼동하지 않고, 단계별 기준·센서 배치·데이터 이관 계획을 계측관리계획서에 명시합니다.</p><p>계측 데이터는 <strong>계측책임자</strong>가 검토하는 계측관리계획서의 계측 빈도·<strong>설계예상변위</strong>·<strong>최대허용변위</strong>와 연계하여 운영합니다. 댐·제방 현장에서는 추세·변화속도·인접 센서의 동시 변화를 우선 검토하며, 현장별 상세 시방·허용값은 설계도서와 발주처 기준을 따릅니다.</p>",
      "purpose": [
        {
          "title": "축조 단계 안전",
          "body": "기초·제체·연속 콘크리트 단계 변위·응력을 추적합니다."
        },
        {
          "title": "성토·제방",
      ...
      "principle": "<p>댐 건설기간 계측은 <strong>단면·공정·센서</strong>를 공정표와 동기화합니다. <strong>간극수압계·침하계·지중경사계·변형률계</strong> 데이터는 현장 <strong>데이터로거</strong> → 통신 → <strong>데이터 관리</strong> → <strong>원격 모니터링</strong> 대시보드로 흐릅니다. 준공 시 운영기 안전관리 DB로 이관합니다.</p>",
      "installation": [
        "계측관리계획서에 건설기간 항목·공정별 측점·관리기준을 명시합니다.",
      ...
      "criteria": "<p>건설기간 관리기준은 설계·시공 단계별 허용 변위·수압·온도 상승률로 설정합니다. 운영기 댐 안전관리 기준(홍수·누수·간극수압 패턴)과 별도 관리합니다. KCS에 따라 현장 <strong>계측책임자</strong>가 계측관리계획서·측정·보고·기준 초과 대응을 총괄합니다.</p>",
      "faq": [
        {
          "q": "건설기간과 누수·간극수압(운영기) 차이는?",
          "a": "건설기간은 축조·성토·수화열·기초 단계, 운영기는 충수·홍수·장기 누수·안전관리 패턴 중심입니다."
        },
        {
        ...
        {
          "q": "준공 후 데이터는?",
          "a": "건설기간 기준·이력·센서 상태를 운영기 안전관리 DB·계측관리계획으로 이관합니다."
        }
      ],
      "sources": "<div class=\"tech-sources\" id=\"sources\"><h2 class=\"tech-sources__title\">근거 기준</h2><ul class=\"tech-sources__list\"><li class=\"tech-sources__item\">· <strong>KCS 54 20 25:2018</strong>「댐 계측설비」 §3 — 댐·제방 계측설비 <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li><li class=\"tech-sources__item\">· <strong>KDS 11 10 15:2025</strong>「지반계측」 §4.1 — 댐·제체 계측 일반 <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li></ul><p class=\"tech-sources__disclaimer\">※ 본 자료는 건설기준(KDS/KCS) 해설이며, 구체적 관리기준·허용값·시공 상세는 설계도서, 계측관리계획서, 발주처 지침을 우선 적용합니다.</p></div>"
    },
    ...
    "heroImageId": "IMG-113",
    "heroCaption": "댐·제방 건설기간 계측 — 축조·성토 단계 변위·수압·원격계측 SW",
    "metaDescription": "댐·제방 건설기간 계측 — 축조·성토 단계 변위·수압·온도와 원격계측 SW 연계. Dam construction monitoring and integrated monitoring software.",
    "standardSources": [
      {
        "grade": "B",
        "docId": "KCS-54-20-25",
  ...
  "fields/foundation-pile/precast-pile": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "항타 검증",
          "body": "관입 깊이·항타 에너지 대비 축력을 확인합니다."
        },
        {
          "title": "축력",
  ...
  "sensors/piezometer": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "간극수압",
          "body": "성토·수위 변화에 따른 토층 압력을 추적합니다."
        },
        {
          "title": "압밀",
          "body": "소산 곡선으로 압밀 진행을 확인합니다."
        },
        {
          "title": "안정",
  ...
  "sensors/remote-monitoring-system": {
    ...
    "sections": {
      "overview": "<p><strong>원격계측시스템</strong>은 센서, 데이터로거, 통신, 서버, DB, 웹 대시보드, 모바일 경보를 통합해 현장 계측을 실시간·주기 관리합니다. 자동화계측의 완성 형태입니다.</p><p>구성: 센서 → 데이터로거 → 게이트웨이/LTE → 서버 → DB → 웹 대시보드 → 모바일 알림 → 보고서</p><p><strong>적용 현장:</strong> 댐·제방·터널·철도 <strong>건설기간 계측</strong> 현장에서 다측점·다공정 데이터를 24시간 수집·경보합니다. 축조·굴착·道床 시공 단계의 QC·일·주 보고와 연동합니다.</p>",
      "purpose": [
        {
          "title": "통합",
          "body": "다현장·다센서 일원화"
  ...
  "instruments/data-management": {
    ...
    "sections": {
      "overview": "<p><strong>데이터 관리</strong>는 현장에서 수집된 계측값을 <strong>저장·검증·보고·경보</strong>까지 운영하는 계측 시스템 계층입니다. 센서·로거·통신 하드웨어와 별도로, <strong>결측·이상값 처리</strong>, 관리기준 대비 추세 분석, 자동 보고서, 담당자 알림을 체계화합니다.</p><p>NMTI는 제품 판매가 아니라 <strong>발주처·설계 기준에 맞는 데이터 운영 프로세스</strong> 구성·유지관리를 수행합니다. <strong>댐·제방 건설기간 계측</strong> 현장에서는 층별 침하·수압·온도 QC, 일·주 보고, 준공 시 운영기 안전관리 DB 이관을 같은 계층에서 운영합니다. 고급 통합·예측 분석은 필요 시 <a href=\"#instruments/modes/smart\">스마트 계측</a>·<a href=\"#instruments/modes/ai\">AI 계측</a> 항목으로 확장할 수 있습니다.</p>",
      "purpose": [
        {
          "title": "데이터 품질",
