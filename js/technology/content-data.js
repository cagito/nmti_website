...
const CONTENT = {
  ...
  "fields/retaining-excavation": {
    ...
    "sections": {
      ...
      "installation": [
        ...
        "인접 건물에는 균열계 · 구조물경사계 · 측량 프리즘을 배치 · 초기 상태 기록",
  ...
  "fields/structural-safety": {
    ...
    "sections": {
      "overview": "<p><strong>구조물 안전계측</strong>은 기존 구조물 또는 시공 중 구조물의 균열, 경사, 변위, 진동을 측정하여 안전성 및 사용성 변화를 감시하는 계측입니다. 인접 굴착, 기초 침하, 온도 변화, 반복하중, 노후화에 의해 균열과 변형이 발생할 수 있습니다.</p><p>초기 상태를 기록하고 시간에 따른 변화를 추적하여 보수·보강 필요성을 판단하는 근거를 제공합니다. <strong>균열계</strong>, <strong>구조물경사계</strong>, <strong>변위계</strong>, <strong>진동계</strong>, <strong>변형률계</strong>, <strong>GNSS</strong>를 조합하며, 온도·계절에 따른 정상 반복 거동과 구조적 이상을 구분합니다. 인접 공사 영향 평가에서도 핵심 역할을 합니다.</p>",
      "purpose": [
        {
          "title": "손상 추적",
        ...
        {
          "title": "변위 감시",
          "body": "절대·상대 변위를 <strong>변위계</strong>, <strong>GNSS</strong>로 추적합니다."
        },
        {
          "title": "동적 특성",
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "균열계·구조물경사계·변위계 조합이 일반적이며, 구조물 유형에 따라 GNSS·진동계를 보완합니다."
        },
        {
          "q": "진동 기준은 구조물마다 다른가요?",
  ...
  "fields/railway": {
    ...
    "sections": {
      ...
      "purpose": [
        {
          "title": "노반 안정",
          "body": "노반 침하·융기를 <strong>침하계</strong>, <strong>GNSS</strong>로 고빈도 감시합니다."
        },
        {
          "title": "궤도 변위",
      ...
      "principle": "<p>철도 계측은 mm 단위 변위와 μm/s~mm/s 진동 속도 관리가 일반적입니다. 침하계는 국부 수직변위, 변위계는 궤도·구조물 국부 변위, GNSS는 장거리 추세, 진동계는 발파·공사·열차 이벤트를 포착합니다. 기준점 안정성과 대기·시야 조건이 해석 품질을 좌우합니다.</p>",
      "installation": [
  ...
  "fields/retaining-excavation/earth-retaining-wall": {
    ...
    "sections": {
      ...
      "installation": [
        ...
        "인접 건물: 균열계(균열에 수직 교차), 구조물경사계(외벽 · 기둥), 필요 시 측량 프리즘(절대 변위) 설치",
  ...
  "fields/retaining-excavation/adjacent-building": {
    ...
    "title": "주변건물",
    "sections": {
      "overview": "<p><strong>주변건물</strong> 계측은 굴착·터널·성토 등 인접 공사가 기존 건축물에 미치는 영향을 <strong>균열계</strong>, <strong>구조물경사계</strong>, <strong>측량 프리즘</strong>(절대 변위)으로 정량 관리합니다. 건물은 기초 형식·구조·노후도에 따라 민감도가 크게 다릅니다.</p><p>사전 조사로 균열·경사·변위 기준 상태를 기록하고, 공사 중 변화량을 추적합니다. 균열 폭 증가·건물 경사·절대 변위가 동시에 진행되면 즉시 원인 분석·공법 조정이 필요합니다. 온도·계절에 따른 정상 변동과 구분하는 것이 해석의 출발점입니다.</p><p>인접 건물 계측은 사전·공사 중·공사 후 3단계로 계획하며, 민감 건물은 계측 빈도를 일 1회 이상으로 설정하기도 합니다. 균열·경사·총변위가 동시에 증가하면 지반 수평변위·차등 침하를 의심하고, 단일 센서만 증가하면 센서·온도·설치 상태를 우선 점검합니다. 보고서에는 위치 도면·사진·초기 대비 변화량 표를 포함하는 것이 분쟁 예방에 도움이 됩니다.</p>",
      "purpose": [
        {
          "title": "균열 감시",
        ...
        {
          "title": "절대 변위",
          "body": "<strong>측량 프리즘</strong>·<strong>GNSS</strong>로 절대 변위 추세 확인"
        }
      ],
  ...
  "fields/retaining-excavation/surrounding-ground": {
    ...
    "title": "주변지반",
    "sections": {
      "overview": "<p><strong>주변지반</strong> 계측은 굴착·성토 영향권 내 지반의 침하·수평변위·간극수압 변화를 확인합니다. 흙막이 배면 변위와 지표·지중 변위는 연속체이므로 <strong>지중경사계</strong>, <strong>침하계</strong>, <strong>간극수압계</strong>를 굴착 경계에서 일정 거리마다 배치합니다.</p><p>양수에 따른 지하수위 저하가 원거리 침하를 유발할 수 있어 <strong>지하수위계</strong>와 침하 데이터를 연계합니다. 주변 도로·상하수도·지하매설물에 대한 영향 평가의 핵심 자료가 됩니다.</p><p>주변지반 계측 단면은 굴착선에 수직하는 단면과 평행하는 단면을 함께 두면 3차원 거동 파악에 유리합니다. 양수에 따른 원거리 침하는 지하수위계·침하계 상관으로 조기에 감지할 수 있으며, 상하수도·전력 구간 인접 시 해당 관리 주체와 계측 데이터를 공유합니다. 영향권 밖 기준점은 GNSS로 보완해 절대 변위 추세를 확인합니다.</p><p>계측 데이터는 <strong>계측책임자</strong>가 검토하는 계측관리계획서의 계측 빈도·<strong>설계예상변위</strong>·<strong>최대허용변위</strong>와 연계하여 운영합니다. 가시설·흙막이 현장에서는 추세·변화속도·인접 센서의 동시 변화를 우선 검토하며, 현장별 상세 시방·허용값은 설계도서와 발주처 기준을 따릅니다.</p>",
      "purpose": [
        {
          "title": "수평변위",
  ...
  "fields/bridge/pier": {
    ...
    "sections": {
      ...
      "purpose": [
        ...
        {
          "title": "변위",
          "body": "받침·신축 상대변위(변위계)와 절대 좌표변위(측량 프리즘·GNSS)를 구분합니다."
        },
        {
          "title": "응력",
      ...
      "installation": [
        ...
        "교각 상부 프리즘과 영향권 밖 GNSS로 절대 좌표변위 확인",
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "받침·신축부는 변위계로 상대변위, 교각 프리즘·GNSS로 절대 좌표변위를 구분해 기록합니다."
        },
        {
  ...
  "fields/bridge/foundation-settlement": {
    ...
    "sections": {
      ...
      "installation": [
        "기초 · 교각 · 주변 지반에 침하 측점(프리즘)을 두고 지표침하계 · GNSS로 표고 변화 확인",
      ...
      "faq": [
        ...
        {
          "q": "기준점(BM)은 어디에 두나요?",
          "a": "침하 영향권 밖 안정 지반 또는 구조물에 두고, GNSS·수준측량과 연계합니다."
        }
      ],
      "sources": "<div class=\"tech-sources\" id=\"sources\"><h2 class=\"tech-sources__title\">근거 기준</h2><ul class=\"tech-sources__list\"><li class=\"tech-sources__item\">· <strong>KCS 24 99 05:2023</strong>「교량계측시설」 §3.1 — 교량 계측시설 시공 <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li><li class=\"tech-sources__item\">· <strong>KDS 11 10 15:2025</strong>「지반계측」 §4.1 — 교량·구조물 계측 일반 <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li><li class=\"tech-sources__item\">· <strong>KCS 24 99 05:2023</strong>「교량계측시설」 — 대구 3호선 통합 유지관리 10종 <span class=\"tech-sources__grade\">[D]</span> <span class=\"tech-sources__publisher\">(국가건설기준센터(KCSC))</span></li></ul><p class=\"tech-sources__disclaimer\">※ 본 자료는 건설기준(KDS/KCS) 해설이며, 구체적 관리기준·허용값·시공 상세는 설계도서, 계측관리계획서, 발주처 지침을 우선 적용합니다.</p></div>"
    },
    ...
    "sections": {
      ...
      "faq": [
        ...
        },
        {
          ...
          "a": "연약층 구분이 필요하면 층별침하계, 총 침하만 필요하면 표고침하·지표침하계를 씁니다."
        },
        {
          "q": "압밀과 즉시침하 구분은?",
  ...
  "fields/railway/track-displacement": {
    ...
    "title": "궤도변위",
    "sections": {
      "overview": "<p><strong>궤도변위</strong>는 선로의 수평·수직 위치 변화(선형·고저·통과·轨距)를 정밀 측량·<strong>변위계</strong>·<strong>GNSS</strong>로 관리합니다. 인접 공사·지반 침하·온도에 따른 궤도 틀어짐은 운행 안전에 직결됩니다.</p><p>노반침하와 함께 3차원 거동을 평가합니다.</p><p>궤도변위는 선로 유지관리 TQI·통과 변위 등 철도 고유 지표와 연계됩니다. 온도·열차 하중·인접 공사를 이벤트로 태깅하면 이상 변위 원인 분석이 수월해지며, 교량 접속부는 별도 측점망을 구성합니다.</p><p>계측 데이터는 <strong>계측책임자</strong>가 검토하는 계측관리계획서의 계측 빈도·<strong>설계예상변위</strong>·<strong>최대허용변위</strong>와 연계하여 운영합니다. 철도 현장에서는 추세·변화속도·인접 센서의 동시 변화를 우선 검토하며, 현장별 상세 시방·허용값은 설계도서와 발주처 기준을 따릅니다.</p>",
      "purpose": [
        {
          "title": "선형 유지",
          "body": "평면·종단 변위 추적"
      ...
      "faq": [
        ...
        {
          "q": "열차 운행 중 측정 가능한가요?",
          "a": "정밀 측량은 운행 시간대를 피하거나 협약된 창구에 실시합니다. 자동 센서는 연속 수집이 가능합니다."
        },
        {
          "q": "궤도 변위와 선로 기준은?",
  ...
  "fields/railway/construction-phase": {
    ...
    "sections": {
      ...
      "principle": "<p>철도 건설중 계측은 <strong>노반·궤도·하부 지반</strong>을 분리 해석합니다. 궤도틀림·노반침하·진동 그래프를 한 축에 혼합하지 않고, <strong>침하계·변위계·GNSS</strong>를 공정 단계에 맞게 배치합니다.</p>",
      "installation": [
  ...
  "fields/dam/tilt": {
    ...
    "title": "기울기",
    "sections": {
      "overview": "<p><strong>댐·제방 기울기</strong> 계측은 제체 크레스트·익스트의 경사·회전을 <strong>구조물경사계</strong>, <strong>GNSS</strong>로 측정합니다(KCS 54 20 25). 비대칭 기울기는 부등침하·내부 손상·기초 불안 징후일 수 있습니다.</p><p>침하계·변위계·GNSS 데이터와 함께 제체 거동을 평가합니다.</p><p>댐 기울기는 부등침하·비대칭 변형의 징후입니다. 침하·변위·간극수압 데이터와 통합해 내부 손상 가능성을 평가합니다.</p><p>계측 데이터는 <strong>계측책임자</strong>가 검토하는 계측관리계획서의 계측 빈도·<strong>설계예상변위</strong>·<strong>최대허용변위</strong>와 연계하여 운영합니다. 댐·제방 현장에서는 추세·변화속도·인접 센서의 동시 변화를 우선 검토하며, 현장별 상세 시방·허용값은 설계도서와 발주처 기준을 따릅니다.</p>",
      "purpose": [
        {
          "title": "경사",
          "body": "제체 기울기 변화 추적"
  ...
  "sensors/displacement-transducer": {
    ...
    "sections": {
      ...
      "faq": [
        ...
        {
          "q": "변위계와 광학 측량?",
          "a": "변위계는 국부 상대 변위에 적합합니다. 터널·깊은 굴착 등 지하공사에서 절대 좌표·다점 광학측량 보조가 필요할 수 있습니다(KDS 4.1.5)."
        },
        {
          "q": "앵커 느슨하면?",
          "a": "허위 변위 발생. 정기 점검 필수."
  ...
  "sensors/automated-total-station": {
    ...
    "sections": {
      "overview": "<p><strong>자동광파기</strong>는 원격 제어 토탈스테이션으로 프리즘·반사 타깃 3D 좌표를 반복 측정해 변위를 산정합니다. <strong>주로 터널·깊은 굴착·흙막이</strong> 등 <strong>지반 하부 공사</strong> 중 다점 좌표 계측에 사용합니다(ATS-SUB-01).</p>",
      "purpose": [
        {
          "title": "3D 변위",
          "body": "고빈도·고정밀 좌표"
  ...
  "sensors/gnss": {
    ...
    "sections": {
      "overview": "<p><strong>GNSS</strong>(<strong>GPS</strong> 등 위성항법) 계측은 기준국·이동국 GNSS 안테나로 구조물·지반의 장기 <strong>3D 변위</strong>(ΔX·ΔY·ΔZ)를 측정합니다. 대형 <strong>사면</strong>, <strong>댐</strong>, <strong>교량</strong>, 지반침하, 장대 구조물·원거리 계측에 적용하며, 현장 구성은 <strong>기준국</strong>(안정 지반) + <strong>이동국</strong> 복수 측점 + <strong>RTK</strong>·차분 보정 + <strong>LTE</strong>·무선 → <strong>중앙 서버</strong> 수집·분석 흐름입니다.</p><p>Figure(IMG-043)은 현장 계측 계획서·<a href=\"/homepage/book/GNSS.pdf\" target=\"_blank\" rel=\"noopener noreferrer\">GNSS 계측 시스템 구성(PDF)</a>과 동일한 개념(기준국·이동국·서버·무선·3D 변위)을 따릅니다.</p>",
      "purpose": [
        {
          "title": "장기 추세",
      ...
      "criteria": "<p>장기 한계변위·변화속도 기준은 설계·KCS·발주처 기준을 따릅니다. 지표침하 연계 시 KCS 11 10 15 등 측정오차 요건을 확인합니다. 단기 고정밀·고빈도는 GNSS만으로 부족할 수 있어 변위계·지중경사계와 병행합니다. KCS에 따라 현장 <strong>계측책임자</strong>가 계측관리계획서·측정·보고·기준 초과 대응을 총괄합니다.</p>",
      "faq": [
        {
          "q": "GNSS vs 변위계·침하계?",
          "a": "GNSS는 장기·원거리·다점 3D, 변위계·침하계는 국부·고빈도. 목적에 맞게 병행합니다."
        },
        {
          "q": "GPS와 GNSS 차이?",
