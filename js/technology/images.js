...
export const IMAGE_ASSETS = {
  ...
  'IMG-004': {
    ...
    status: 'reviewed',
    reviewGrade: 'PASS',
    reviewDoc: 'docs/IMAGE_REVIEW_LOG.md#IMG-004 · docs/180-technology-이미지-전수-재검수-수정계획.md · docs/181-이미지별-계측오류-금지조건-정본.md#img-004 · docs/188-IMG-004-v8-재생성-기록.md · docs/54-IMG-004-어스앵커-하중계-설치-표현-표준.md · docs/83-어스앵커-하중계-ANC-CLOCK-정본.md',
    prohibitedErrors: [
      '하중계를 지반 내부에 배치',
      '정착장·그라우트체 내부에 하중계',
      '자유장 중간에 하중계 삽입',
